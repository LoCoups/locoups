    ...
    <form>
      <div className='flex' style={{ width: "50em" }}>
        ...
        <div className='relative w-full'>
          ...
          <button
            type='submit'
            className='absolute block top-0 end-0 p-2.5 z-20 h-14 text-sm font-medium text-white bg-blue-700 rounded-e-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
          >
            <svg
              className='w-3 h-4'
              aria-hidden='true'
